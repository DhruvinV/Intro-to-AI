...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        return self.DFMiniMax(gameState, my_table)[0]
...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        my_table["moves"] = 0
        my_table["agent_index"] = 0
        return self.AlphaBeta(gameState, my_table,float('inf'),-float('inf'))[0]
...
class ExpectimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
      ...
      my_table["moves"] = 0
      my_table["agent_index"] = 0
      return self.Expectimax(gameState, my_table)[0]
...
def betterEvaluationFunction(currentGameState):
  """
      ...
      - cost of eating 1/4 of all closest food pellet(food-gobbling)(1/4 to reduce amount of computation done)
      - Distance to closest non-scared ghost.
      - Number of food pellets left.
      - Number of capsules left. 
     As provided in the hint, using reciprocal of values instead of actual values to better make sense
     of the values. Negative scores for capsule_number and food pellet number to motivate pac man to go for them.
     and reduce. Similar negative score is giving to ghost distance making it undesirable to go after them
  ...
  # get esitmate of the eating all the 1/4 food dots from current postion
  ...
  if(len(estimate) == 0):
    ...
    for i in estimate:
      total_cost += i
    distance["food-dis"] = 1/total_cost
